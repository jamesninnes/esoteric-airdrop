...
async function main() {
    ...
    const Clothes = await hre.ethers.getContractFactory("Clothes");
    const clothes = await Clothes.attach("0xca7ca7bcc765f77339be2d648ba53ce9c8a262bd");
    let eventFilter = clothes.filters.Transfer(zero, null, null)
    let events = await getLogs(clothes, eventFilter, lastBlock)
